...
class CollectionDocument implements Document {
  final List<ResourceContainer> collection;
  final List<ResourceContainer> included;

  final Link self;
  final Pagination pagination;

  CollectionDocument(List<ResourceContainer> collection,
      {List<ResourceContainer> included, this.self, this.pagination})
  ...
  static CollectionDocument fromJson(Object json) {
    if (json is Map) {
      ...
      if (data is List) {
        ...
        return CollectionDocument(data.map(ResourceContainer.fromJson).toList(),
