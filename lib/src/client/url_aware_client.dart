...
class UrlAwareClient {
  ...
  UrlAwareClient(UrlFactory urlFactory,
      {JsonApiClient jsonApiClient, http.Client httpClient})
      : this._(jsonApiClient ?? JsonApiClient(httpClient ?? http.Client()),
            urlFactory);

  UrlAwareClient._(this._client, this._url);
  ...
  Future<Response<ResourceData>> createResource(Resource resource,
      ...
      _client.createResource(_url.collection(resource.type), resource,
          headers: headers);
  ...
  Future<Response<ResourceData>> fetchResource(String type, String id,
      ...
      _client.fetchResource(_url.resource(type, id),
  ...
  Future<Response<ResourceCollectionData>> fetchCollection(String type,
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchCollection(_url.collection(type),
          headers: headers, parameters: parameters);
  ...
  Future<Response<ResourceData>> fetchRelatedResource(
          ...
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchResource(_url.related(type, id, relationship),
          headers: headers, parameters: parameters);
  ...
  Future<Response<ResourceCollectionData>> fetchRelatedCollection(
          String type, String id, String relationship,
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchCollection(_url.related(type, id, relationship),
          headers: headers, parameters: parameters);
  ...
  Future<Response<ToOne>> fetchToOne(
          String type, String id, String relationship,
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchToOne(_url.relationship(type, id, relationship),
          headers: headers, parameters: parameters);
  ...
  Future<Response<Relationship>> fetchRelationship(
          String type, String id, String relationship,
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchRelationship(_url.relationship(type, id, relationship),
          headers: headers, parameters: parameters);
  ...
  Future<Response<ToMany>> fetchToMany(
          String type, String id, String relationship,
          {Map<String, String> headers, QueryParameters parameters}) =>
      _client.fetchToMany(_url.relationship(type, id, relationship),
          headers: headers, parameters: parameters);
  ...
  Future<Response> deleteResource(String type, String id,
          {Map<String, String> headers}) =>
      _client.deleteResource(_url.resource(type, id), headers: headers);
  ...
  Future<Response<ToOne>> deleteToOne(
          String type, String id, String relationship,
          {Map<String, String> headers}) =>
      _client.deleteToOne(_url.relationship(type, id, relationship),
          headers: headers);
  ...
  Future<Response<ToMany>> deleteFromToMany(String type, String id,
      ...
      _client.deleteFromToMany(
          _url.relationship(type, id, relationship), identifiers,
          headers: headers);
  ...
  Future<Response<ResourceData>> updateResource(Resource resource,
      ...
      _client.updateResource(
          _url.resource(resource.type, resource.id), resource,
          headers: headers);
  ...
  Future<Response<ToOne>> replaceToOne(
      ...
      _client.replaceToOne(
          _url.relationship(type, id, relationship), identifier,
          headers: headers);
