    ...
    group('to-one', () {
      group('replace', () {
        test('204 No Content', () async {
          ...
          final original = r0.document.toIdentifier();
          ...
          final updated = r2.document.toIdentifier();
    ...
    group('to-many', () {
      ...
      group('replace', () {
        test('204 No Content', () async {
          ...
          final original = r0.document.toIdentifiers().map((_) => _.id);
          ...
          final updated = r2.document.toIdentifiers().map((_) => _.id);
          expect(updated, ['5', '6']);
        });
      });
      ...
      group('add', () {
        test('200 OK', () async {
          ...
          final updated = r1.document.toIdentifiers().map((_) => _.id);
